...
/// <summary>
/// Запрос на обновление значений полей в задаче.
/// </summary>
/// <remarks>
/// Изменятся только те поля, которые указаны в запросе. Остальные поля останутся без изменений.
/// </remarks>
public record UpdateIssueRequest : CustomFieldsRequest
{
	/// <summary>
	/// Название задачи.
	/// </summary>
